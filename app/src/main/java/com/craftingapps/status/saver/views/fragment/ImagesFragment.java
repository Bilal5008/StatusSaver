...
import com.craftingapps.status.saver.databinding.FragmentImageBinding;
...
public class ImagesFragment extends Fragment {
    ...
    ArrayList<StatusModel> imagesList;
    ...
    private void setUpRecyclerView() {
        statusAdapter = new StatusAdapter(getContext(), imagesList);
        binding.imagesRecycler.setHasFixedSize(true);
        binding.imagesRecycler.setLayoutManager(new GridLayoutManager(getContext(), 2));
        binding.imagesRecycler.setAdapter(statusAdapter);
    ...
    private ArrayList<StatusModel> getImagesList() {
        StatusModel status;
